...
namespace MediCloud.BusinessProcess.Financeiro.Reports
{
    public class ControleDeRelatoriosFinanceiros
    {
        ...
        public static byte[] ImprimirRelatorioDeMovimentos(int idProcedimento, string idProfissional, int idFornecedor, DateTime? dataInicialExame, DateTime? dataFinalExame, int idFuncionario, int idCliente)
        {
            CloudMedContext contexto = new CloudMedContext();
